...
Models and timing tracks can be reordered directly in the sequencer by dragging their row in the row header (the names column on the left) up or down to the position you want.
