...
| **Number of Waves**      | <p>Controls how many waves are formed across the model. This is a float cycles value (roughly 0.5 to 10.0), allowing partial waves and fine adjustment. Existing sequences are migrated automatically.</p><p>Can be adjusted via the Value Curves options.</p>                                                                                                                                                                                                      |
