...
| **Timing Track** | A timing track can be selected to trigger the shockwave. When set, a new shockwave is started at each mark in the chosen timing track instead of running continuously for the effect duration.                            |
