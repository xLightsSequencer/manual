...
![Layout Tab](<../.gitbook/assets/image (571).png>)

First Select the 'Matrix' model icon in the Model Toolbar.

![Matrix Model ](<../.gitbook/assets/image (211).png>)
...
![LED Panel Output Page](<../.gitbook/assets/image (544).png>)
...
![Octoscroller](<../.gitbook/assets/image (410).png>)
